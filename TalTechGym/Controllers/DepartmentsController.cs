...
namespace TalTechGym.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public DepartmentsController(TalTechGymContext context)
        {
            _context = context;
        }
        ...
        {
            var talTechGymContext = _context.Departments.Include(d => d.Administrator);
            return View(await talTechGymContext.ToListAsync());
        }
